...
| `media_luna_dashboard.html` | Single-file web dashboard; reads `window.STATIC_DATA.phCalibrating` when static |
| `site/` | GitHub Pages export — `index.html` + `agent.html` generated by `/export/dashboard` + `/export/agent`; deploy triggers on push to `site/` |
