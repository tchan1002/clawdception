...
```bash
# Compile ESP32 sensor hub (safe to run anytime)
...
# Monitor ESP32 sensor hub serial output
arduino-cli monitor --port /dev/cu.usbserial-0001 --config baudrate=115200

# Compile ESP32-CAM
arduino-cli compile --fqbn esp32:esp32:esp32cam ~/clawdception/esp32_cam
